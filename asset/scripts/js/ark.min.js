...
var ArkAdmin = new function($) {
  ...
  function initDatePickers() {
    ...
    $('.input-group-addon .fa.fa-calendar').parent().on('click', function(){
    	var objectdata = $(this).parent();
    	objectdata[0].children[0].select();
    });
  }
                                        ...
                                        case "ellipsis":
                                          ...
                                          function initMaps() {
                                            ...
                                            this.initExamples = function() {
                                             ...
                                             // 	var calendarEvent = '[{"title" : "All Day Event","start" : "2015-03-01"},{"title" : "All Day Event 2 ","start" : "2015-03-04"},{"title" : "All Day Event 3","start" : "2015-03-07"}]';
                                             // }
                                              if (typeof calendarEvent != 'undefined'){
	                                              var objCalEvent = JSON.parse(calendarEvent);
	                                            }
