...
$data = [];
$data[] = ['cmt' => 'Assigned data'];
$data[] = ['cmt' => 'is something that'];
$data[] = ['cmt' => 'can be quite powerful.'];
...
$TBS->Assigned['expl_1'] = [
    ...
    &$data,
    'auto' => 'onload'
]; // Note that the data array is given by reference in order to prevent from copying the data in memory.
// Assign data for a manual merging
$TBS->Assigned['expl_2'] = ['b_manual', &$data];
