...
if ($db->connect()) {
    ...
    $strDefaultDate = date($_SESSION['sessionDateSetting']['php_format']);
    $strDefaultDate2 = date("Y-m-d");

    $strTempDate = getNextDateNextMonth($strDefaultDate2, -1);
    $strTempDate2 = getNextDateNextMonth($strDefaultDate2, 1);

    $arrDtLastMonth = explode("-", $strTempDate);
    $arrDtNextMonth = explode("-", $strTempDate2);
    $arrDtThisMonth = explode("-", $strDefaultDate2);

    $strDefaultFromDefault =  $arrDtThisMonth[0] . "-" . $arrDtThisMonth[1] . "-01" ;
    $strDefaultThruDefault =  $arrDtThisMonth[0] . "-" . $arrDtThisMonth[1] . "-". lastday($arrDtThisMonth[1], $arrDtThisMonth[0]);
    $strDefaultFromSCDefault = $arrDtLastMonth[0] . "-" . $arrDtLastMonth[1] . "-" . "18";
    $strDefaultThruSCDefault = $arrDtThisMonth[0] . "-" . $arrDtThisMonth[1] . "-" . "17";

    $strDefaultFrom = sqlToStandarDateNew($strDefaultFromDefault, $_SESSION['sessionDateSetting']['date_sparator'], $_SESSION['sessionDateFormat']);
    $strDefaultThru = sqlToStandarDateNew($strDefaultThruDefault, $_SESSION['sessionDateSetting']['date_sparator'], $_SESSION['sessionDateFormat']);
    $strDefaultFromSC = sqlToStandarDateNew($strDefaultFromSCDefault, $_SESSION['sessionDateSetting']['date_sparator'], $_SESSION['sessionDateFormat']);
    $strDefaultThruSC = sqlToStandarDateNew($strDefaultThruSCDefault, $_SESSION['sessionDateSetting']['date_sparator'], $_SESSION['sessionDateFormat']);
    ...
    $strInputSCDateFrom = "<input class=\"form-control datepicker\" type=text name=\"dataDateFromSC\" id=\"dataDateFromSC\" maxlength=10 value=\"$strDefaultFromSC\" data-date-format=\"" . $_SESSION['sessionDateSetting']['html_format'] . "\">";
    $strInputSCDateThru = "<input class=\"form-control datepicker\" type=text name=dataDateThruSC id=dataDateThruSC maxlength=10 value=\"$strDefaultThruSC\" data-date-format=\"" . $_SESSION['sessionDateSetting']['html_format'] . "\">";
