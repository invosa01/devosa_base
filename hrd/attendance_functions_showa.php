...
var $arrAttendanceChanges;

  var $arrBarcode; // nik, sebagai filter

  var $arrBreakTime; // kriteria, sebagai filter

  // atribut sebagai data pendukung, dalam array

var $arrEmployee;       // daftar jadwal shift

  var $arrOT;       // daftar jadwal shift

  var $arrOutOffice;  // daftar kehadiran
...
var $bolNeedCalculateLate;
  ...
  var $bolYesterday;             // jam pulang normal, hh:mm:ss
    ...
    var $fltOT2;       // jam mulai early ot aktual, hh:mm:ss

    var $fltOT3;      // jam selesai early ot aktual, hh:mm:ss

    var $fltOT4;            // jam mulai ot aktual

  var $fltOT5;           // jam selesai ot aktual

  var $fltOTCalculated;            // total durasi jam masuk dan pulang, dalam menit (yang dianggap aktual jam kerja)

  var $fltTotalOT;        // total durasi jam masuk dan pulang, full

  var $intAbsenceType;        // apakah perlu hitung keterlambatan

  var $intEarly;                     // apakah terlambat

  var $intLate;                     // jumlah menit keterlambatan

  var $intLateDeduction;                    // jumlah menit pulang awal

  var $intTotalDuration;            // potongan keterlambatan, yang akan mengurangi lembur

  var $intTotalDurationFull;                    // apakah perlu dihitung OTnya atau diabaikan
...
var $strAttendanceFinish;
  ...
  var $strAttendanceID;                      // andai ada

  var $strAttendanceStart;                  // total OT, dalam menit

    var $strBranchCode;                  // total OT, dalam menit

    var $strDataSource;      // apakah sedang dianggap absen atau tidak

    var $strIDEmployee;      // apakah termasuk hari libur, hari libur nasional
