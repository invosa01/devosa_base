  ...
  for ($counter = 1; $counter <= $intNumData; $counter++) {
    ...
    if (isset($_POST['detailFamilyID' . $counter])) {
      ...
      if ($data['name'] == '') {
        ...
        $isSuccess = $tblCandidateFamily->update(["id" => intval(getPostValue('detailFamilyID' . $counter))], $data);
      }
    } else {
      //insert mode
  ...
  for ($counter = 1; $counter <= $intNumData; $counter++) {
    ...
    if (isset($_POST['detailLanguageID' . $counter])) {
      ...
      if (getPostValue("detailLanguageDelete" . $counter) == 1) {
        ...
        //edit old data
        $isSuccess = $tblCandidateLanguage->update(["id" => intval($_POST['detailLanguageID' . $counter])], $data);
      }
    } else {
      //insert mode
      if (getPostValue("detailLanguageDelete" . $counter) != 1) {
  ...
  for ($counter = 1; $counter <= $intNumData; $counter++) {
    ...
    if (isset($_POST['detailFormalEducationID' . $counter])) {
      ...
      if (getPostValue("detailFormalEducationDelete" . $counter) == 1) {
        //delete old data
        $isSuccess = $tblCandidateEducation->delete(["id" => intval($_POST['detailFormalEducationID' . $counter])]);
      } else {
        //edit old data
        $isSuccess = $tblCandidateEducation->iy(["id" => intval($_POST['detailFormalEducationID' . $counter])], $data);
      }
    } else {
      //insert mode
      if (getPostValue("detailFormalEducationDelete" . $counter) != 1) {
