...
function getAnnualTax($db, $intYear, $strKriteria = "")
{
    ...
    while ($row = $db->fetchrow($res)) {
        ...
        $strSQL2 = "SELECT t0.\"id_employee\", t0.\"employee_id\", \"base_tax\", \"base_irregular_tax\", tax, \"irregular_tax\" , jkk_allowance, \"basic_salary\", t0.npwp,
                        t1.\"tax_status_code\", t1.\"join_date\", t1.\"resign_date\", t1.\"employee_name\", \"primary_address\",t1.\"primary_city\",t1.\"primary_zip\", t1.gender, t2.\"tax_reduction\", t3.\"position_name\", t2.children, t2.\"marital_status\", t0.jamsostek_deduction, t0.pension_deduction
    ...
    foreach ($arrResult as $arrEmployee) {
        ...
        //        die($sResult);
        $arrResult[$strIDEmployee]['get'] = "<div id=\"div-$strIDEmployee\">
                                            <input id=\"val-$strIDEmployee\" type=\"hidden\" name=\"val-$strIDEmployee\" value=\"$sResult\">
                                            <input id=\"row-$strIDEmployee\" type=\"hidden\" name=\"row-$strIDEmployee\" value=\"$i\">
                                            <a href=\"#\" id=\"button-$strIDEmployee\" class=\"1721-export btn btn-small btn-primary\">Form 1721-A1</a>
                                            </div>";
        //Total Per Kolom
