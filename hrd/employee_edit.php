...
function getData($db, &$arrData)
{
    ...
    if ($strDataID == "") {
        ...
        if ($rowDb = $db->fetchrow($resDb)) {
            ...
            $arrData['dataBirthday'] = sqlToStandarDateNew(
                $rowDb['birthday'],
            ...
            $arrData['dataWeddingDate'] = sqlToStandarDateNew(
                $rowDb['wedding_date'],
                $_SESSION['sessionDateSetting']['date_sparator'],
                $_SESSION['sessionDateFormat']
            );
            ...
            $arrData['dataJoinDate'] = sqlToStandarDateNew(
                $rowDb['join_date'],
                $_SESSION['sessionDateSetting']['date_sparator'],
                $_SESSION['sessionDateFormat']
            );
            $arrData['dataDueDate'] = sqlToStandarDateNew(
                $rowDb['due_date'],
                $_SESSION['sessionDateSetting']['date_sparator'],
                $_SESSION['sessionDateFormat']
            );
            $arrData['dataPermanentDate'] = sqlToStandarDateNew(
                $rowDb['permanent_date'],
                $_SESSION['sessionDateSetting']['date_sparator'],
                $_SESSION['sessionDateFormat']
            );
            $arrData['dataResignDate'] = sqlToStandarDateNew(
                $rowDb['resign_date'],
                $_SESSION['sessionDateSetting']['date_sparator'],
                $_SESSION['sessionDateFormat']
            );
...
function saveData($db, &$strDataID, &$strError)
{
    ...
    (isset($_REQUEST['dataBirthday'])) ? $strDataBirthday = standardDateToSQLDateNew(
        $_REQUEST['dataBirthday'],
        $_SESSION['sessionDateSetting']['date_sparator'],
    ...
    (isset($_REQUEST['dataWeddingDate'])) ? $strDataWeddingDate = standardDateToSQLDateNew(
        $_REQUEST['dataWeddingDate'],
        $_SESSION['sessionDateSetting']['date_sparator'],
        $_SESSION['sessionDateSetting']['pos_year'],
        $_SESSION['sessionDateSetting']['pos_month'],
        $_SESSION['sessionDateSetting']['pos_day']
    ...
    (isset($_REQUEST['dataJoinDate'])) ? $strDataJoinDate = standardDateToSQLDateNew(
        $_REQUEST['dataJoinDate'],
        $_SESSION['sessionDateSetting']['date_sparator'],
        $_SESSION['sessionDateSetting']['pos_year'],
        $_SESSION['sessionDateSetting']['pos_month'],
        $_SESSION['sessionDateSetting']['pos_day']
    ) : $strJoinDate = "";
    (isset($_REQUEST['dataDueDate'])) ? $strDataDueDate = standardDateToSQLDateNew(
        $_REQUEST['dataDueDate'],
        $_SESSION['sessionDateSetting']['date_sparator'],
        $_SESSION['sessionDateSetting']['pos_year'],
        $_SESSION['sessionDateSetting']['pos_month'],
        $_SESSION['sessionDateSetting']['pos_day']
    ) : $strDueDate = "";
    (isset($_REQUEST['dataPermanentDate'])) ? $strDataPermanentDate = standardDateToSQLDateNew(
        $_REQUEST['dataPermanentDate'],
        $_SESSION['sessionDateSetting']['date_sparator'],
        $_SESSION['sessionDateSetting']['pos_year'],
        $_SESSION['sessionDateSetting']['pos_month'],
        $_SESSION['sessionDateSetting']['pos_day']
    ) : $strPermanentDate = "";
    (isset($_REQUEST['dataResignDate'])) ? $strDataResignDate = standardDateToSQLDateNew(
        $_REQUEST['dataResignDate'],
        $_SESSION['sessionDateSetting']['date_sparator'],
        $_SESSION['sessionDateSetting']['pos_year'],
        $_SESSION['sessionDateSetting']['pos_month'],
        $_SESSION['sessionDateSetting']['pos_day']
