...
$strSQL = "SELECT t0.*, employee_name, employee_id FROM hrd_leave_additional_request AS t0 LEFT JOIN hrd_employee AS t1 ON t0.id_employee = t1.id
                   WHERE t1.active =1 ";
...
function printEditLink($params)
{
    ...
    return "
      ...
      <input type=hidden name='detailEmployee$counter' id='detailEmployee$counter' value='" . $record['employee_id'] . "' />
