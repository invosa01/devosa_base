    ...
    if ($dataMasterSalary == 0) {
        ...
        if ($strType == 0) {
            ...
            $myDataGrid->addColumn(
                new DataGrid_Column(
                    getWords("total karyawan bulan lalu"),
                    "total_employee_prev",
                    ["rowspan" => 1, 'width' => 120],
                    ['nowrap' => ''],
                    true,
            ...
            $myDataGrid->addColumn(
                new DataGrid_Column(
                    getWords("total jamsostek bulan lalu"),
            ...
            $myDataGrid->addColumn(
                new DataGrid_Column(
                    getWords("total jamsostek karyawan baru join"),
            ...
            $myDataGrid->addColumn(
                new DataGrid_Column(
                    getWords("total jamsostek karyawan resign"),
        ...
        if (isset($_POST['btnExportXLS'])) {
            ...
            if (INSERT_JAMSOSTEK_LOGO === true) {
                $myDataGrid->insertJamsostekLogo = true;
            }
        }
