...
$strDetailFooter .= "<td><input class='btn btn-sm btn-danger' name='btnDelete' type='button' id='btnDelete' value='" . getWords("delete") . "' onClick='DeleteData();'></td>";
...
//
                ...
                $arrData['dataDetail'] .= "  <td><input class='form-control-sized' type=text name='detailStartEarlyPlan$intTotalData' id='detailStartEarlyPlan$intTotalData' value='" . substr($arrData['dataStartEarly'], 0, 5) . "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' $strDisabledEarly></td>";

                $arrData['dataDetail'] .= "  <td><input class='form-control-sized' type='text' name='detailFinishEarlyPlan$intTotalData' id='detailFinishEarlyPlan$intTotalData' value='" . substr($arrData['dataFinishEarly'], 0, 5) . "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' $strDisabledEarly></td>";
                ...
                $arrData['dataDetail'] .= "  <td><strong><input class='form-control-sized' type=text name='detailStartEarlyActual$intTotalData' id='detailStartEarlyActual$intTotalData' value='" . substr($arrTmp['start_early_actual'], 0, 5) . "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' $strDisabledEarly></strong></td>";

                $arrData['dataDetail'] .= "  <td><input class='form-control-sized' type='text' name='detailFinishEarlyActual$intTotalData' id='detailFinishEarlyActual$intTotalData' value='" . substr($arrTmp['finish_early_actual'], 0, 5) . "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' $strDisabledEarly></td>";

                $arrData['dataDetail'] .= "  <td><input class='form-control-sized' type='text' name='detailStartActual$intTotalData' id='detailStartActual$intTotalData' value='" . substr($arrTmp['start_actual'], 0, 5) . "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' readonly></td>";

                $arrData['dataDetail'] .= "  <td><input class='form-control-sized' type='text' name='detailFinishActual$intTotalData' id='detailFinishActual$intTotalData' value='" . substr($arrTmp['finish_actual'], 0, 5) . "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' readonly></td>";
                ...
                $arrData['dataDetail'] .= "  <td><input class='form-control-sized' type='text' name='detailStartPlan$intTotalData' id='detailStartPlan$intTotalData' value='" . substr($arrData['dataStart'], 0, 5) . "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' readonly></td>";

                $arrData['dataDetail'] .= "  <td><input class='form-control-sized' type='text' name='detailFinishPlan$intTotalData' id='detailFinishPlan$intTotalData' value='" . substr($arrData['dataFinish'], 0, 5) . "' size=5 maxlength=5 onChange='checkAttendance($intTotalData)' readonly></td>";
                ...
                $arrData['dataDetail'] .= "  <td><input class='form-control-sized' type=text name='detailAttendanceStart$intTotalData' id='detailAttendanceStart$intTotalData' value='" . substr($arrTmp['attendance_start'], 0, 5) . "' size=5 readonly></td>";
                $arrData['dataDetail'] .= "  <td><input class='form-control-sized' type=text name='detailAttendanceFinish$intTotalData' id='detailAttendanceFinish$intTotalData' value='" . substr($arrTmp['attendance_finish'], 0, 5) . "' size=5 readonly></td>";
...
function saveData($db, &$strDataID, &$strError)
{
    ...
    $tempDateEntry = $arrDate[2] . "-" . $arrDate[1] . "-" . $arrDate[0];*/
    $tempDateEntry = standardDateToSQLDateNew(
        $_REQUEST['dataEntryDate'],
    ...
    $tempDataDate = standardDateToSQLDateNew(
        $_REQUEST['dataDate'],
        $_SESSION['sessionDateSetting']['date_sparator'],
        $_SESSION['sessionDateSetting']['pos_year'],
        $_SESSION['sessionDateSetting']['pos_month'],
    ...
    if ($strDataEarly == "f") {
        ...
        $tempDataDate = $arrDate[2] . "-" . $arrDate[1] . "-" . $arrDate[0];
...
{
    if ($strListID == "") return "";
    $strNewDate = standardDateToSQLDateNew(
        $strDate,
        $_SESSION['sessionDateSetting']['date_sparator'],
        $_SESSION['sessionDateSetting']['pos_year'],
        $_SESSION['sessionDateSetting']['pos_month'],
    ...
    $strSQL .= "FROM hrd_attendance WHERE attendance_date = '$strNewDate' AND id_employee IN ($strListID)";
    $resS = $db->execute($strSQL);
    while ($rowS = $db->fetchrow($resS)) {
    ...
    $strSQL .= "WHERE shift_date = '$strNewDate' AND id_employee IN ($strListID)";
    $resS = $db->execute($strSQL);
    while ($rowS = $db->fetchrow($resS)) {
...
function getDataBreak($db, $tipe, $strDataID)
{
    ...
    while ($rowDb = $db->fetchrow($resDb)) {
        ...
        $strResult .= "  <td><input type=hidden name=dataID$tipe" . "_$i value=" . $rowDb['id'] . "><input class='form-control' type=text name=dataBreak$tipe" . "_$i size=12 maxlength=10 value=" . substr($rowDb['start_time'], 0, 5) . "></td>\n";
...
if ($db->connect()) {
    ...
    if (empty($maxOTMember)){
        $maxOTMember = 25;//Mencegah error saat add to list jika $maxOTMember nya kosong
    }
    ...
    scopeData($arrUserInfo['employee_id'], $strDataSubSection, $strDataSection, $strDataSubDepartment, $strDataDepartment, $strDataDivision, $_SESSION['sessionUserRole'], $arrUserInfo);
    ...
    $strInputEmployee2 = "<input class='btn btn-primary btn-xs' type=button id=btnAdd name=btnAdd value='" . getWords("add to list") . "'  onClick='addEmployee(document.formInput.dataEmployee.value)' >";
    ...
    $strInputEntryDate = "<input class='form-control datepicker' type=text name=dataEntryDate id=dataEntryDate size=12 maxlength=10   value=\"" . $arrData['dataEntryDate'] . "\" readonly data-date-format='" . $_SESSION['sessionDateSetting']['html_format'] . "'>";
    $strInputDate = "<input class='form-control datepicker' type=text name=dataDate id=dataDate size=12 maxlength=10 value='" . $arrData['dataDate'] . "' data-date-format='" . $_SESSION['sessionDateSetting']['html_format'] . "'>";
    $strInputDivision = getDivisionList($db, "dataDivision", $strDataDivision, $strEmptyOption, "", " onChange=\"searchEmployee()\" " . $ARRAY_DISABLE_GROUP['division']);
    $strInputDepartment = getDepartmentList($db, "dataDepartment", $strDataDepartment, $strEmptyOption, "", " onChange=\"searchEmployee()\" " . $ARRAY_DISABLE_GROUP['department']);
    $strInputSection = getSectionList($db, "dataSection", $strDataSection, $strEmptyOption, "", " onChange=\"searchEmployee()\" " . $ARRAY_DISABLE_GROUP['section']);
    $strInputSubSection = getSubSectionList($db, "dataSubSection", $strDataSubSection, $strEmptyOption, "", " onChange=\"searchEmployee()\"" . $ARRAY_DISABLE_GROUP['sub_section']);
