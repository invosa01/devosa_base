...
$arrSetting = [
  ...
  "strDays"  => ["code" => "days_per_month", "value" => "0", "note" => "Total Days Per Month", "default" => "0",],
  "strRound" => ["code" => "salary_round", "value" => "100", "note" => "Salary Rounding Factor", "default" => "100",],
  ...
  "strLoanOT"       => ["code" => "loan_deduction_ot", "value" => "t", "note" => "Loan include OT", "default" => "t",],
  "strLoanTax"      => [
  ...
  "strZakatAmount"   => ["code" => "zakat_deduction", "value" => "0", "note" => "Amount for Zakat", "default" => "0",],
  "strZakatActive"   => [
  ...
  "strZakatShow"     => ["code" => "zakat_deduction_show", "value" => "t", "note" => "Show Zakat ", "default" => "t",],
  "strZakatProrate"  => [
