...
$strWordSubDepartment = getWords("sub department");
...
function getData(
    ...
    $strSQL .= "LEFT JOIN hrd_sub_department AS t6 ON t1.sub_department_code = t6.sub_department_code ";
...
function saveData($db)
{
    ...
    for ($i = 1; $i <= $intTotalData; $i++) {
        ...
        if ($strDataID != "") {
            ...
            (isset($_REQUEST['dataAllowance1_" ' . $i])) ? $fltBasic = $_REQUEST['dataAllowance1_' . $i] : $fltBasic = 0;
            //(isset($_REQUEST['dataGrade1" ' . $i])) ? $fltBasic = $_REQUEST['dataGrade1' . $i] : $fltBasic = 0;
            //  echo $_REQUEST['dataAllowance2_'.$i]."|";
            $fltBasic = $_REQUEST['dataAllowance1_' . $i];
            //$fltBasic = $_REQUEST['dataGrade1' . $i];
            $strSQLAllowance =
