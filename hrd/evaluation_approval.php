...
function getData($db)
{
  ...
  if ($db->connect()) {
    ...
    $myDataGrid->addColumn(new DataGrid_Column(getWords("evaluation date"), "evaluation_date", "", ['nowrap' => '']));
    ...
    $myDataGrid->addColumn(
        new DataGrid_Column(getWords("remarks"), "remarks", "", ['width' => '100', 'valign' => 'top', 'nowrap' => ''])
    );
    $myDataGrid->addColumn(
